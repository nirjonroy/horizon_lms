...
<body style="font-family: Arial, sans-serif; color: #111827; background-color: #f9fafb; margin: 0; padding: 24px;">
    <div style="max-width: 640px; margin: 0 auto; background-color: #ffffff; border: 1px solid #e5e7eb; border-radius: 12px; padding: 24px;">
        <h2 style="margin-top: 0;">Thank you for your application, {{ $studentData['first_name'] ?? 'Student' }}!</h2>
        <p>We have received your application for {{ $studentData['selected_program_name'] ?? ($studentData['course_name'] ?? 'your selected program') }}.</p>
        <p style="margin-bottom: 20px;">Below is a summary of the details we received:</p>

        <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
            <tr>
                <td style="padding: 8px; border: 1px solid #e5e7eb;">Full name</td>
                <td style="padding: 8px; border: 1px solid #e5e7eb;">{{ $studentData['full_name'] ?? 'N/A' }}</td>
            </tr>
            <tr>
        ...
        <p style="margin-top: 20px;">We will get back to you soon with the next steps.</p>
    </div>
</body>
</html>
