            ...
            <form role="form" action="{{route('admin.fees.online.store')}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="programInput" placeholder="Add title of program" name="program" value="{{ old('program') }}">
                </div>
                <div class="form-group">
                    <label for="slugInput">Slug</label>
                    <input type="text" class="form-control" id="slugInput" name="slug" placeholder="Auto-generated" value="{{ old('slug') }}">
                ...
                <div class="form-group">
                    ...
                    <small class="text-muted">Upload a PDF syllabus for this program.</small>
                </div>
