...
class sliderController extends Controller
{
    ...
    public function store(Request $request){
        ...
        if ($request->hasFile('image')) {
            $slider->image = $this->uploadImage($request->file('image'), 'image');
        }
        ...
        $slider->button_one_link = $request->button_one_link;
        $slider->button_two_text = $request->button_two_text;
        $slider->button_two_link = $request->button_two_link;
    ...
    public function destroy($id)
{
    ...
    $this->deleteImageIfExists($slider->image);
